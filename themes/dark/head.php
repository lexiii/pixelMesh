...
<link rel="stylesheet" href="//maxcdn.bootstrapcdn.com/bootswatch/3.1.1/cyborg/bootstrap.min.css">
...
<link rel="stylesheet" href="<?php echo $config['path']."themes/".$config['theme']; ?>/css/main.css">
<?php
