...
$files  = array_diff(scandir($config['root'] . 'res'), array( '..', '.'));
$pages  = count(array_diff(scandir($config['root'] . 'pages'), array( '..', '.')));
$upages = count(array_diff(scandir($config['root'] . 'extra'), array( '..', '.')));
$files2 = array_diff(scandir($config['root'] . 'admin/tmp'), array( '..', '.'));
$count  = count($files);
$count2 = count($files2);
if ($count != 0)
