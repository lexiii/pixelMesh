...
if(isset($single)&&$single==1){//links to image
	echo "<center><a href='res/".$lat[$i][0]."'><img src='".$config['root']."res/".$lat[$i][0]."' class='gal'/></a></center>";
}else{ //links to single page
	echo "<center><a href='".$config['root']."page.php?".$i."'><img src='".$config['root']."res/".$lat[$i][0]."' class='gal'/></a></center>";
}
